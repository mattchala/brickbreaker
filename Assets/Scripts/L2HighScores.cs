...
public class L2HighScores : MonoBehaviour
{

    public static L2HighScores Instance;
    ...
    {   
        ...
        if (scene == "Level_2_High_Scores") 
        {
            ...
            string jsonHighScoresString = PlayerPrefs.GetString("Level_2_High_Scores_Table");
    ...
    public void NewHighScore(int score, string playerName)
    {
        ...
        PlayerPrefs.SetString("Level_2_High_Scores_Table", jsonHighScoresEntryList);
        PlayerPrefs.Save();
    }
    ...
    {
        PlayerPrefs.DeleteKey("Level_2_High_Scores_Table");
        PlayerPrefs.Save();
        SceneManager.LoadScene("Level_2_High_Scores");
    }
